		...
		for($i=1;$i<=6;$i++) {
			...
			switch ($suffix) {
				case 'in':
					...
					$key=array("school", "college", "education", "university", "hotel", "class", "foundation", "study", "hospital", "medical", "science", "medicine", "sanatorium", "scientific", "primary", "technology", "student", "teacher", "institution", "enterprise", "green", "solution", "group", "hostel", "faculty", "revolution", "baby","academy","org.in");
					break;
				case 'org':
					# code...
